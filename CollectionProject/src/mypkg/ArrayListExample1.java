...
public class ArrayListExample1 {
	...
	public static void main(String[] args) {
		...
		//list.add(26,new Integer(4)); // runtime error
		...
		System.out.println("Total Size "+list.size());
		  ...
		  if (list.contains(new Integer(4))) {
			   System.out.println("ArrayList contains 4 as value");
			  } else {
			   System.out.println("ArrayList does not contain 4 as value");
			  }
		  System.out.println("--------------------------------------");
		
		  Integer one = (Integer) list.get(3);
		  System.out.println("Value at 3 index is " + one);
		  System.out.println("--------------------------------------");
		  ...
		  System.out.println("--------------------------------------");
           ...
           System.out.println(list);
  		  System.out.println("--------------------------------------");
		  System.out.println("Is 4 removed from the ArrayList ? "
